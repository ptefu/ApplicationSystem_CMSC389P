...
<html>
<head>
    <title>Update Application Retrieval Form</title>
</head>

<body>
    <form action="updateApplicationRetrievalForm.php" method="post">
            ...
            if($result) {
                while ($retrievedDataArray = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                    if($_POST['emailToRetrieve'] == $retrievedDataArray['email'] && hash_equals($retrievedDataArray['password'], crypt($_POST['passwordToRetrieve'], $retrievedDataArray['password']))/*$_POST['passwordToRetrieve'] == $retrievedDataArray['password']*/) {
                        ...
                        $password = $_POST['passwordToRetrieve']; //set to unencrypted bc preset value for update form page
                    }
                }
                if($name == "") {
                    ...
                    header("Location: updateApplicationForm.php");
                }
            } else {
